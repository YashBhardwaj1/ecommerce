...
<h3>Your Shopping Cart</h3>
    <div id="shopping-cart-results">
            ...
            <div id="heading-block">
                                <img style="margin-left: -33px" src="images/shaadi11.jpg" alt="shaadi">
            ...
            <div class="column right2">
                <form name="myForm" onsubmit="return validateForm()" action="sell.php" method="post">
                 <label style="margin-left: 20px; margin-bottom: 10px;">Breed:</label><br>
                 <select style="width: 30%;height: 10%; margin-left: 20px" name="breed">
                 <option value="breed">Affenpinscher</option>
                 <option value="breed">Akita</option>
                 <option value="breed">Afghan Hound</option>
                 <option value="breed">Australian Cattle Dog</option>
                 <option value="breed">Pomerian</option>      
                  </select>
                  
                 
                 <br><br><input style="margin-left: 20px" type="radio" name = "KCI" value="KCI" checked>KCI REGISTERED
                 <input type="radio" name = "KCI" value="NON KCI" > NON KCI REGISTERED<br>    
