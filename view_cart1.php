...
<body>
<h3 style="text-align:center">Sold Item Details.</h3>
<?php
if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){
    ...
    echo 'Name: '.$product_name.'||| Quantity: '.$product_qty.' ||| Price: '.$product_price.'|||  Color: '.$product_color.' ||| Code:  '.$product_code.'||| Size: '.$product_size.''
?>   
</body>
</html>