...
<?php
	...
	$sql = "SELECT * FROM shaadi";
	$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
   
    while($row = mysqli_fetch_assoc($result)) {
    echo "<h4>ID: </h4>" . $row["ID"]. "<br>" .  "Name: " . $row["name"] .  "<br>" . "Category: " . $row["category"]. "<br>" .  "Sex: " . $row["sex"] . "<br>" .  "color: " . $row["color"] . "<br>" .  "Age: " . $row["age"] ."<br>" .  "Email: " . $row["email"] .       "<br><br><br>";
	 }
} else {
