    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="logo">
                ...
                <!--Search Area-->
                <div id="search">
                <form class="Search" action="about.php" target="_blank" method="get">
    ...
    <div id="shopping-cart-results">
            ...
            <div id="heading-block4"> 
                <h4>Female Names</h4>
                    ...
                    <input style="width: 28%;height: 40px;border-style: solid;border-color: black;margin-left: 5px;text-align: center;margin-top: 10px" type="text" value="Brownie" name="MN"> 
