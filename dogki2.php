...
<h3>Your Shopping Cart</h3>
    <div id="shopping-cart-results">
            ...
            <div id="heading-block">
                ...
                <img style="margin-left: 15px " src="images/shaadi4.jpg" height="200px" width="50%" alt="shaadi">
                <img style="margin-left: -33px " src="images/shaadi5.jpg" height="200px" width="50%" alt="shaadi">
            ...
            <div class="column right7">
                ...
                <input style="width: 10%;height:5%; text-align: center" type="text" name="email" required ><br>    
